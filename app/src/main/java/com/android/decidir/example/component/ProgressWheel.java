package com.android.decidir.example.component;
...
/**
 * Created by biandra on 21/08/16.
 */
public class ProgressWheel extends View {
    ...
    private int contourColor = 0xFFFFFF;
    private int circleColor = 0xFFFFFF;
    private int rimColor = 0xFFFFFF;
    private int textColor = 0xFF000000;
    private int gradientBarStartColor = getResources().getColor(
            R.color.cyan_progress);
    private int gradientBarEndColor = getResources().getColor(
            R.color.white_progress);
    ...
    private void setupPaints() {
        ...
        if (gradient) {
            barPaint.setShader(new LinearGradient(0, 0, 0, getHeight(),
                    gradientBarStartColor, gradientBarEndColor,
    ...
    private void parseAttributes(TypedArray a) {
        ...
        modeSpin = (boolean) a.getBoolean(R.styleable.ProgressWheel_modeSpin, true);
        ...
        if (a.getBoolean(R.styleable.ProgressWheel_gradientBar, gradient)) {
            gradientBarEndColor = a.getColor(
                    R.styleable.ProgressWheel_gradientBarEndColor,
                    gradientBarEndColor);
            gradientBarStartColor = a.getColor(
                    R.styleable.ProgressWheel_gradientBarStartColor,
                    gradientBarStartColor);
        } else {
            gradient = false;
        }
